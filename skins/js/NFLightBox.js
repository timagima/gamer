...
(function($) {
    $.fn.lightBox = function(settings) {
        ...
        settings = jQuery.extend({
            ...
            imageLoading: '/skins/img/gallery/loading.gif',
            imageBtnPrev: '/skins/img/gallery/prev.png',
            imageBtnNext: '/skins/img/gallery/next.png',
            imageBtnClose: '/skins/img/gallery/close.png',
            imageBlank: '/skins/img/gallery/lightbox-blank.gif',
            imageBtnBottomPrev: '/skins/img/gallery/btm_prev.gif',
            imageBtnBottomNext: '/skins/img/gallery/btm_next.gif',
            imageBtnPlay: '/skins/img/gallery/start.png',
            imageBtnStop: '/skins/img/gallery/pause.png',
