$(function(){
    ...
    function addCompletedGames(){
        ...
        $.ajax({
            ...
            url: document.location.href,
            dataType: 'html',
            data: {'ajax-query': 'true', 'type-class': 'model', 'method':'AddCompletedGame', 'game': game, 'game-level': gameLevel, 'game-description': gameDescription, 'game-start-date': gameStart, 'game-end-date': gameEnd, 'not-game-start': notGameStart, 'not-game-end': notGameEnd},
            beforeSend: function(){
