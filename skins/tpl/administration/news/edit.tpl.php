...
<form action="<?= Url::Action("edit", "administration.news") ?>" method="POST">
    ...
    <div class="field" style="width: 800px;">
        ...
        <div id="info-others" style="padding: 10px;">
            <?php } foreach($data['img'] as $r){
                echo "<div class='left'><img style='width:75px; padding-right: 10px;' src='/".$r->filename."'></div>";
            }
            ?>
        </div>
    </div>
