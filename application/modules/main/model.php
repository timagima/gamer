...
class Model extends MainModel
{
    ...
    {
        $arr = $this->conn->dbh->query("SELECT phone FROM users WHERE phone <> '' LIMIT 0, 35")->fetchAll(PDO::FETCH_OBJ);
        $msg = "Приглашаем вас принять участие в турнире по игре DOTA 2";
        //$msg = "Уважаемый Hey Jey вы заняли почетное третье место в первой серии игр по турниру DOTA 2";
        foreach($arr as $r)
        {
